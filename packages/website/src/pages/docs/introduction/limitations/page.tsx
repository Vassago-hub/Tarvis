	...
	return (
		<div className="max-w-4xl mx-auto">
			...
			<div className="prose prose-lg dark:prose-invert max-w-none">
				{/* Runtime Scope */}
				<Heading id="runtime-scope" className="text-2xl font-bold mb-3">
					{isZh ? '运行范围' : 'Runtime Scope'}
				</Heading>
				<p className="text-gray-600 dark:text-gray-300 mb-4">
					{isZh
						? 'Page Agent 作为页面内 SDK 运行，能力边界限定在当前页面和网站主动集成的服务流程内。'
						: 'Page Agent runs as an in-page SDK. Its capability boundary is the current page and service flows intentionally integrated by the website.'}
				</p>
